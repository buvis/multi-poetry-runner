...
from multi_poetry_runner.utils.config import ConfigManager, RepositoryConfig, WorkspaceConfig
...
def sample_config(temp_workspace):
    ...
    config_file = temp_workspace / "bdt-config.yaml"
...
def test_config_manager_init(temp_workspace):
    ...
    assert config_manager.config_file.resolve() == (temp_workspace / "bdt-config.yaml").resolve()


def test_load_config(temp_workspace, sample_config):
    """Test loading configuration from file."""
    config_manager = ConfigManager(config_file=sample_config, workspace_root=temp_workspace)
...
def test_get_dependency_order_circular(temp_workspace):
    ...
    config_manager = ConfigManager(config_file=config_file, workspace_root=temp_workspace)
